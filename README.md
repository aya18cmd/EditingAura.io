...
<head>
    ...
    <style>
        ...
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .btn-primary:hover{transform:translateY(-2px);box-shadow:0 8px 20px rgba(0,198,255,.4)}
        ...
        header h1{font-size:clamp(2.5rem,6vw,5rem);font-weight:700;letter-spacing:-2px;background:linear-gradient(90deg,var(--accent),var(--accent-glow));-webkit-background-clip:text;-webkit-text-fill-color:transparent}
